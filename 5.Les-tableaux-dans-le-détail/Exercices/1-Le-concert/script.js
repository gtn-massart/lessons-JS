...
console.log(concertRoom.splice(0,2,{name: "Thomas", age: 19}, {name: "Clara", age: 21}));
console.log(concertRoom);
...
concertRoom.forEach(el => {
    console.log(`Salut ${el.name}, le concert commencera d'ici deux heures !`);    
});
