...
*/
    ...
    const data = [
      ...
      },
      {
        title: "Lorem ipsum",
        symbol: "📗",
        content: `<img src='1' onerror='console.log("Code malicieux")'>` // code malicieux
      }]
...
/* 
      ...
      Ici c'est une méthode alert(), mais ça pourrait être une récupération de cookies qu'on pourrait envoyer vers un tier.
